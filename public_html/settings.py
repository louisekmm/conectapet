...
SECRET_KEY = '%d5ssksu)z$(&m!@ijoar=u$0=s&z-=6nddgi)my@yla8^wak^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['192.185.176.178','.conectapet.com','.conectapet.com.']


# Application definition

INSTALLED_APPS = [
    'conectapet.apps.ConectapetConfig',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cone8536_conectapet-db',
	'USER': 'cone8536_louise',
	'PASSWORD': 'loulogica',
...
AUTH_USER_MODEL = 'conectapet.User' #modelo de usuario personalizado
